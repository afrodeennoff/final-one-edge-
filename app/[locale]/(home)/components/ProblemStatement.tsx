    ...
    return (
        <section id="problem" className="py-32 px-6 bg-[#040404] border-t border-white/5 relative">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-start">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded border border-red-500/20 bg-red-500/5 mb-8">
                ...
                <div className="grid gap-6">
                    {[
                        ...
                        >
                            <div className="bg-[#080808] p-8 rounded-lg h-full border border-white/5 relative overflow-hidden group-hover:border-teal-500/20 transition-colors">
                                <div className="absolute top-4 right-4 text-[9px] font-mono text-zinc-700 group-hover:text-red-400 transition-colors">
                                    {item.code}
                                </div>
                                <div className="flex items-start gap-6">
                                    <div className="text-zinc-800 font-mono text-2xl font-bold mt-1 group-hover:text-teal-500 transition-colors">0{i + 1}</div>
                                    <div>
                                        <h3 className="text-xl font-bold mb-3 tracking-tight text-zinc-200 group-hover:text-white transition-colors">{item.title}</h3>
